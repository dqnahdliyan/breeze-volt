...
<body class="antialiased">
    <div
        class="relative min-h-screen sm:flex sm:justify-center sm:items-center selection:bg-red-500 selection:text-white">
        @if (Route::has('login'))
        ...
        <div class="p-6 mx-auto max-w-7xl lg:p-8">
            <div class="flex justify-center">
                <x-application-logo class="w-auto h-16 fill-red-500" />
            </div>
